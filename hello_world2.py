...
class Game_Window(FloatLayout):
    def __init__(self, **kwargs):
       ...
       self.question = Label(
           ...
           size_hint=(0.8 , 0.15),
           font_size=(70),
           pos_hint={"center_x": 0.24, "center_y":0.6},
           color="#33cccc"              
           )
...
class Options_Menue(FloatLayout):
    ...
    def volume_button_behavior(self, *args):
         self.play_click_sound()
         if self.click_sound.volume < 1:
            self.click_sound.volume += 0.1  # Increase volume by 10%
            print(f"Volume increased: {self.click_sound.volume}")
         elif self.click_sound.volume == 1:
             self.click_sound.volume = 0
